...
//       try {
//         const response = await axios.get("http://intranet.higherindia.net:3006/api/categories/fetch");
...
//     try {
//       const response = await axios.get(`http://intranet.higherindia.net:3006/api/tables/table-data/${categoryName}`);
//       setTableData({
...
//       const response = await axios.post(`http://intranet.higherindia.net:3006/api/tables/insert/${selectedCategory}`, payloadToSend, {
...
//         ? `http://intranet.higherindia.net:3006/api/crud/update/${selectedCategory}/${editingAssetId}` // Update
//         : `http://intranet.higherindia.net:3006/api/tables/insert/${selectedCategory}`; // Create new
...
//         try {
//           const url = `http://intranet.higherindia.net:3006/api/crud/delete/${selectedCategory}/${assetId}`;
...
const AssetManagementPage = () => {
  ...
  const fetchTableData = async (categoryName = selectedCategory) => {
    try {
      const response = await axios.get('https://intranet.higherindia.net:8443/api/tables/table-data/${categoryName}');
        setTableData({
          columns: response.data.columns || [],
          data: response.data.data || [],
        });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // URL based on editing state (create or update)
      const url = editingAssetId
        ? `https://intranet.higherindia.net:8443/api/crud/update/${selectedCategory}/${editingAssetId}` // Update
      :` https://intranet.higherindia.net:8443/api/tables/insert/${selectedCategory}`; // Create new
...
const confirmDelete = async () => {
  if (assetToDelete !== null) {
    try {
      const url = `https://intranet.higherindia.net:8443/api/crud/delete/${selectedCategory}/${assetToDelete}`;
      const response = await axios.delete(url);
      console.log("Asset deleted successfully:", response.data);
