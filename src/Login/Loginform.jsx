    ...
    <form className="flex flex-col font-medium rounded-none max-w-[330px]">
      ...
      <main className="mt-10">
        <InputField
          ...
          iconSrc="https://cdn.builder.io/api/v1/image/assets/TEMP/29fd2e30067df1de28c44da98f9ed87ee2383917ddf05dd846203fcd9ee14538?placeholderIfAbsent=true&apiKey=f4328c4a551b4b9fa165bba17dc932db"
        />
